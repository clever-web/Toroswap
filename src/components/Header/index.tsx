    ...
    <HeaderFrame>
      ...
      <HeaderRow>
        <Title to="/" style={{ textDecoration: 'none' }}>
          <ToroIcon style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <StyledMobileLogo width={'32px'} height={'36px'} src={Icon} alt="Toroswap" />
            <StyledDesktopLogo width={'40px'} height={'36px'} src={darkMode ? LogoDark : Logo} alt="Toroswap" />
            <h2>Toroswap</h2>
          </ToroIcon>
        </Title>
        <HeaderLinks>
