  ...
  return (
    <>
      <TopSection gap="md">
        <DataCard style={{ marginBottom: '2px' }}>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>TORO Staking</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  Stake TORO to automatically participate in governance and earn TORO rewards. 
                  {/* You can check all
          ...
          {userRewardRate?.greaterThan('0') ? (
            <>
              ...
              <CommunityWrapper showBackground={true} bgColor={theme.primary1}>
                <h3 style={{ margin: 'unset' }}>Community TORO Stake</h3>
                <DescriptionWrapper>
                  <h4 style={{ margin: 'unset' }}>Total TORO Staked</h4>
                  <h4 style={{ margin: 'unset' }}>{Number(totalSupply?.toSignificant(4)).toLocaleString('en-US')}</h4>
                </DescriptionWrapper>
                <DescriptionWrapper>
                  <h4 style={{ margin: 'unset' }}>Your TORO Stake Pool Share</h4>
            ...
            <h3>
              Weekly rewards:{' '}
              {rewardRate ? rewardRate.multiply(BIG_INT_SECONDS_IN_WEEK).toFixed(0, { groupSeparator: ',' }) : '--'} TORO
      ...
      <BodyWrapper style={{ marginTop: '16px' }}>
        ...
        /> */}
        <h2 style={{ textAlign: 'center', margin: '15px 0px 15px 6px' }}>Your TORO Stake</h2>
